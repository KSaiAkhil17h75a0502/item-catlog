...
# Create dummy user
User1 = User(name="Sai Akhil", email="saiakhilkuntamukkala@gmail.com",
             picture='https://www.bing.com/images/search?view=detailV2&id=26968B367AA735BEC47DCC944D35CBD96EC7D673&thid=OIP.2HltJI04FJHJieKu8pF5-AHaHa&mediaurl=https%3A%2F%2Fcdn0.iconfinder.com%2Fdata%2Ficons%2Favatars-6%2F500%2FAvatar_boy_man_people_account_client_male_person_user_work_sport_beard_team_glasses-512.png&exph=512&expw=512&q=beard+user&selectedindex=4&ajaxhist=0&vt=0&eim=2,6')
session.add(User1)
session.commit()
